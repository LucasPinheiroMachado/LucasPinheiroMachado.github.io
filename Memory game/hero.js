...
const srcDefault = 'https://assets.stickpng.com/images/5a461402d099a2ad03f9c997.png'

const src01 = 'http://4.bp.blogspot.com/_oY9YuXBc_Ks/S8-p-kAcXRI/AAAAAAAAFis/UKBqKdXy3Tk/s1600/Batman+%23700+Cover.jpg'
const src02 = 'http://orig06.deviantart.net/a8db/f/2012/175/9/d/deadpool_by_pixeltool-d54q8dz.jpg'
const src03 = 'http://photos1.blogger.com/blogger/970/1668/1600/amazing529.jpg'
const src04 = 'http://4.bp.blogspot.com/-yCuTpb99m-0/Th38wNF8vpI/AAAAAAAADcU/QPfq3XUGb1g/s1600/1310585069.jpg'
const src05 = 'https://c1.staticflickr.com/5/4159/34439347560_406e6f2385_z.jpg'
const src06 = 'http://2.bp.blogspot.com/-SYnqDMsZbFE/T2nLWcjshZI/AAAAAAAAC4s/ruIqLo-OxoI/s1600/WOLVERINE_21.jpg'
...
iniciar.addEventListener('click', function(){
   ...
   while (i < 12) {
    if (numeroAleatorio != v1 && numeroAleatorio != v2 && numeroAleatorio != v3 && numeroAleatorio != v4 && numeroAleatorio != v5 && numeroAleatorio != v6 && numeroAleatorio != v7 && numeroAleatorio != v8 && numeroAleatorio != v9 && numeroAleatorio != v10 && numeroAleatorio != v11 && numeroAleatorio != v12){
  ...
  const atualizarContador = function () {
    contador.textContent = `Tempo: ${segundosRestantes} segundos`;
